...
SUMMITSSL_FIPS_BINARIES_CPE_ID_VERSION = 1.0.2u
...
SUMMITSSL_FIPS_BINARIES_EXTRA_DOWNLOADS = laird_openssl_fips-$(call qstrip,$(BR2_PACKAGE_SUMMITSSL_FIPS_BINARIES_ARCH))-$(SUMMITSSL_FIPS_BINARIES_VERSION).tar.bz2
SUMMITSSL_FIPS_BINARIES_INSTALL_STAGING = YES

ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  SUMMITSSL_FIPS_BINARIES_SITE = $(SUMMIT_SOM_URI_BASE_INTERNAL)/laird_openssl_fips/$(SUMMITSSL_FIPS_BINARIES_VERSION)
else
  SUMMITSSL_FIPS_BINARIES_SITE = $(SUMMIT_SOM_URI_BASE_ARCHIVE)-$(SUMMITSSL_FIPS_BINARIES_VERSION)
endif
