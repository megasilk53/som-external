...
FIPSCHECK_SITE = $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/externals/fipscheck
FIPSCHECK_SITE_METHOD = local
FIPSCHECK_LICENSE = MIT Ezurio
FIPSCHECK_LICENSE_FILES = COPYING LICENSE.ezurio

FIPSCHECK_DEPENDENCIES += openssl host-pkgconf
FIPSCHECK_AUTORECONF = YES

ifeq ($(BR2_TOOLCHAIN_EXTERNAL_SUMMIT_ARM_7),y)
