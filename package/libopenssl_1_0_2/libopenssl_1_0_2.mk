...
# 0017-Add-recipes-for-the-larger-protocols.patch
# 0018-CVE-2023-0215-1of4.patch
# 0019-CVE-2023-0215-2of4.patch
# 0020-CVE-2023-0215-3of4.patch
# 0021-CVE-2023-0215-4of4.patch
# 0022-Groundwork-for-a-perl-based-testing-framework.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-0215

# 0023-CVE-2022-4304.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2022-4304

# 0024-CVE-2023-0286.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-0286

# 0025-CVE-2023-0464.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-0464

# 0026-CVE-2023-0465.patch 
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-0465

# 0027-CVE-2023-0466.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-0466

# 0028-CVE-2023-2650.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-2650

# 0029-CVE-2023-3446.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-3446

# 0030-CVE-2023-3817.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-3817

# 0031-CVE-2023-5678.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2023-5678

# 0032-CVE-2024-0727.patch
LIBOPENSSL_1_0_2_IGNORE_CVES += CVE-2024-0727

ifeq ($(BR2_PACKAGE_SUMMIT_OPENSSL_FIPS),y)
# building from closed source git repository
LIBOPENSSL_1_0_2_VERSION = local
LIBOPENSSL_1_0_2_SITE = $(BR2_EXTERNAL_SUMMIT_FIPS_DEVEL_PATH)/externals/lairdssl_1_0_2
...
ifeq ($(BR2_PACKAGE_SUMMIT_OPENSSL_FIPS_DEBUG),y)
