...
IGCONFD_SITE = $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/externals/igconfd
IGCONFD_SITE_METHOD = local
IGCONFD_SETUP_TYPE = pep517
IGCONFD_DEPENDENCIES = host-python-setuptools
IGCONFD_LICENSE = Ezurio
IGCONFD_LICENSE_FILES = LICENSE.ezurio
