...
ifeq ($(WORKSPACE),)
BACKPORTS_TEST_WORKSPACE = WORKSPACE=$(BASE_DIR)
endif

define HOST_BACKPORTS_TEST_BUILD_CMDS
	$(HOST_MAKE_ENV) $(BACKPORTS_TEST_WORKSPACE) $(BACKPORTS_TEST_TOOLDIR)/backports-update-manager --yes --lrd-repo
	cd $(@D); $(HOST_CONFIGURE_OPTS) $(BACKPORTS_TEST_WORKSPACE) $(BACKPORTS_TEST_TOOLDIR)/ckmake --defconfig=regression-test --nocurses
endef
