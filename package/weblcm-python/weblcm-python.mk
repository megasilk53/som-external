#####################################################################
# Summit Web Configuration Utility
#####################################################################

WEBLCM_PYTHON_VERSION = local
WEBLCM_PYTHON_SITE = $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/externals/weblcm-python
WEBLCM_PYTHON_SITE_METHOD = local
WEBLCM_PYTHON_LICENSE = Ezurio
WEBLCM_PYTHON_LICENSE_FILES = LICENSE.ezurio
...
define WEBLCM_PYTHON_POST_INSTALL_TARGET_HOOK_CMDS2
	$(INSTALL) -D $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/board/configs-common/keys/rest-server/server.crt $(TARGET_DIR)/etc/weblcm-python/ssl/provisioning.crt
	$(INSTALL) -D $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/board/configs-common/keys/rest-server/server.key $(TARGET_DIR)/etc/weblcm-python/ssl/provisioning.key
	$(INSTALL) -D $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/board/configs-common/keys/rest-server/ca.crt $(TARGET_DIR)/etc/weblcm-python/ssl/provisioning.ca.crt
endef
endif
