...
SUMMIT_RCM_LOG_FORWARDING_PLUGIN_SITE = $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/externals/summit-rcm/summit_rcm/plugins/log-forwarding
SUMMIT_RCM_LOG_FORWARDING_PLUGIN_SITE_METHOD = local
SUMMIT_RCM_LOG_FORWARDING_PLUGIN_LICENSE = Ezurio
SUMMIT_RCM_LOG_FORWARDING_PLUGIN_LICENSE_FILES = LICENSE.ezurio
SUMMIT_RCM_LOG_FORWARDING_PLUGIN_SETUP_TYPE = pep517
...
ifeq ($(BR2_PACKAGE_SUMMIT_RCM_REST_API_DOCS),y)
	...
	HOST_SUMMIT_RCM_LOG_FORWARDING_PLUGIN_BUILD_OPTS = && \
		$(HOST_SUMMIT_RCM_LOG_FORWARDING_PLUGIN_ENV) \
