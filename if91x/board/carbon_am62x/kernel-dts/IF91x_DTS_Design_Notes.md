...
The DVK connects via ribbon cable which cannot sustain UHS (1.8V) signaling. `no-1-8-v` forces the SDIO bus to 3.3V High Speed mode, avoiding CRC/EILSEQ errors.
