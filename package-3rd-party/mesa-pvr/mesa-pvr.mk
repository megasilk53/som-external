...
MESA_PVR_GALLIUM_DRIVERS-$(BR2_PACKAGE_MESA_PVR_GALLIUM_DRIVER_POWERVR)  += pvr

# Vulkan Drivers
MESA_PVR_VULKAN_DRIVERS-$(BR2_PACKAGE_MESA_PVR_VULKAN_DRIVER_SWRAST) += swrast
MESA_PVR_VULKAN_DRIVERS-$(BR2_PACKAGE_MESA_PVR_VULKAN_DRIVER_POWERVR) += pvr

ifneq ($(BR2_PACKAGE_MESA_PVR_GALLIUM_DRIVER_POWERVR),)
