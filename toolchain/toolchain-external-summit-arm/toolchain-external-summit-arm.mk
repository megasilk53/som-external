...
TOOLCHAIN_EXTERNAL_SUMMIT_ARM_SOURCE = $(call qstrip,$(BR2_TOOLCHAIN_EXTERNAL_SUMMIT_ARM_PREFIX)-$(BR2_HOSTARCH)_toolchain-$(BR2_TOOLCHAIN_EXTERNAL_SUMMIT_ARM_ID)-$(TOOLCHAIN_EXTERNAL_SUMMIT_ARM_VERSION).tar.gz)
